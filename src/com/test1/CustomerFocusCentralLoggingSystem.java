...
public class CustomerFocusCentralLoggingSystem {
	...
	public CustomerFocusCentralLoggingSystem() {

	}

	public CustomerFocusCentralLoggingSystem(long centralLoggingSystemId, String customerId, String collaterals,
			String bonds, String deposits, long loanUnit, String multiLoanCurr, boolean repayApplicable, long capital,
			long annualReturn, String creationDate, String modifiedDate, String entityState) {
		super();
